      ...
      <div className="container mx-auto px-4">
        <div className="text-center space-y-6 mb-8">
          ...
          <p className="max-w-2xl mx-auto text-base sm:text-lg md:text-xl text-gray-600 leading-relaxed px-2">
            Code Smarter. Scale Faster. Why wait months to hire when your
            project needs to launch now? No compromises. Just results. We match
            you with tech talent that builds, ships, and scales your vision.
          </p>
