...
export default function MultimediaBottom() {
  ...
  return (
    <section className="bg-green-50 py-20 text-center px-4">
      <h3 className="text-3xl font-bold">From Concept to Content Your Multimedia Team Awaits.</h3>

      <p className="mt-4 text-gray-700 max-w-2xl mx-auto">
        Collaborate with expert video editors, animators, designers, and sound engineers to bring
        your creative ideas to life. Reach out today and start your multimedia journey with the
        right talent.
      </p>
