        ...
        <div className="prose prose-lg max-w-none">
          ...
          <section className="mb-10">
            ...
            <ul className="space-y-3 text-gray-700">
              ...
              <li>Account Data – login details, profile preferences, communication history.</li>
              <li>
          ...
          <section className="mb-10">
            ...
            <ul className="space-y-2 text-gray-700">
              ...
              <li>• Connect clients with vetted talent (freelance, part-time, or full-time).</li>
              <li>• Process applications, placements, and service requests.</li>
              <li>• Communicate updates, notifications, and relevant offers.</li>
              <li>• Monitor website usage and improve user experience.</li>
              <li>• Ensure legal compliance and protect against misuse of our platform.</li>
            </ul>
          </section>
          ...
          <section className="mb-10">
            ...
            <ul className="space-y-3 text-gray-700">
              <li>Clients or Employers – if you are applying or matched for roles.</li>
              <li>
                Service Providers – hosting, analytics, and communication tools (under
                confidentiality agreements).
              </li>
              <li>Legal Authorities – if required by UAE law.</li>
            </ul>
          ...
          <section className="mb-10">
            ...
            <ul className="space-y-3 text-gray-700">
              <li>
                We keep your data only as long as necessary to provide our services or as required
                by law.
              </li>
              <li>
                If you delete your account or request removal, we will erase your data within 6
                months, unless a longer period is legally required.
              </li>
            </ul>
          </section>
          ...
          <section className="mb-10">
            ...
            <ul className="space-y-2 text-gray-700">
              ...
              <li>• Withdraw consent to processing (which may limit platform access).</li>
